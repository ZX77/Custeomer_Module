...
<fieldset>
    ...
    <table border="0" height="100" style="margin-left: 60px">
        <tr>
            ...
            <td align="right"><font>入库数量：</font></td>
            <td>
                <input type="text" name="prodCount" id="prodCount"/>
            </td>
            <td align="right"><font>入库单价：</font></td>
            <td>
        ...
        <tr>
            ...
            <td align="right"><font>入库类型：</font></td>
            <td>
...
<table id="tt" style="width:auto;height:auto"
    ...
    <tr>
        ...
        <th data-options="field:'status',width:100,align:'center'">入库类别</th>
